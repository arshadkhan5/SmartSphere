...
class FireFighterScreen  extends ConsumerStatefulWidget {
  ...
  const FireFighterScreen({super.key, required this.alert});
...
class _FireFighterScreenState extends ConsumerState<FireFighterScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)!.fireFighterTracker, style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
